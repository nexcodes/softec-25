...
import { FaDownload, FaGavel, FaPen, FaUserShield } from 'react-icons/fa';
        ...
        <div className='flex flex-col lg:flex-row items-center justify-between gap-12'>
          ...
          >
            <h2 className='text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight'>
              Become A <span className='text-blue-400'>Nigheban</span> To Make
              Pakistan Safer
            </h2>

            <p className='text-gray-300 text-lg md:text-xl mb-8 max-w-2xl'>
              Report a crime you witnessed or experienced — your voice could
              save a life.
            </p>
          ...
          >
            ...
            >
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-400 text-sm'>
                  Be the voice against injustice
                </p>
              </div>
              <div className='text-center'>
