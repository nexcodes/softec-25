...
import { useGetLawyers } from "../_api/use-get-lawyers";

const LawyerPortal = () => {
  const [activeTab, setActiveTab] = useState<"browse" | "register" | "chat">(
    "browse"
  );
  const [searchTerm, setSearchTerm] = useState("");
  const [message, setMessage] = useState("");
  const [chatMessages, setChatMessages] = useState<
    { id: number; sender: "user" | "lawyer"; text: string; timestamp: string }[]
  >([]);

  const { data: lawyers = [] } = useGetLawyers();
  const [selectedLawyer, setSelectedLawyer] = useState<typeof lawyers[0] | null>(
    null
  );
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          <div className="absolute inset-0 rounded-full overflow-hidden border-2 border-blue-500">
                            <img
                              src={
                                lawyer.user.image || "/placeholder-lawyer.jpg"
                              }
              ...
              {selectedLawyer ? (
                  ...
                  <div className="border-b border-gray-700 p-4 flex items-center">
                    <div className="relative mr-3">
                      <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-blue-500">
                        <img
                          src={
                            selectedLawyer.user.image ||
                            "/placeholder-lawyer.jpg"
                          }
                          alt={selectedLawyer.user.name}
                          className="w-full h-full object-cover"
                        />
                      </div>
                    </div>
                    ...
                    {chatMessages.length === 0 ? (
                      <div className="flex flex-col items-center justify-center h-full text-center">
                        ...
                        <p className="text-gray-400">
                          Send a message to {selectedLawyer.user.name} to get legal
                          assistance
                        </p>
                      </div>
                    ) : (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-gray-400 mb-6">
                    Select a lawyer from the browse tab to start a conversation
                  </p>
                  <motion.button
                    onClick={() => setActiveTab("browse")}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8">
              Connect with experienced lawyers who can provide expert advice and
              guidance for all your legal matters. Professional help is just a
              message away.
            </p>
