...
const communityCategories = [
  {
    ...
    icon: <FaUsers />,
    description:
      'Join local neighborhood watch groups to coordinate safety efforts',
  },
  {
    id: 'emergency',
    ...
    <div className='bg-gray-900 text-white min-h-screen'>
      ...
      >
        ...
        <div className='max-w-4xl mx-auto relative z-10 text-center'>
          ...
          >
            Connect with like-minded citizens committed to creating safer
            neighborhoods
          </motion.p>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          >
            ...
            <p className='text-gray-400'>
              Find the right community that matches your safety interests
            </p>
          </motion.div>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-gray-300 text-lg mb-8'>
              Have a passion for safety in your area? Start your own community
              and invite neighbors, friends, and local authorities to join your
              safety initiative.
            </p>
            ...
            <div className='flex flex-col sm:flex-row justify-center gap-4'>
              ...
              <Link
                ...
                className='inline-block bg-gray-800 hover:bg-gray-700 text-white font-medium py-3 px-8 rounded-lg transition-colors border border-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-900'
              >
                Read Guidelines
              </Link>
            </div>
