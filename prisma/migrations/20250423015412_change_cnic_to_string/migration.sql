-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'LAWYER');
...
-- CreateIndex
CREATE UNIQUE INDEX "lawyer_licenseNo_key" ON "lawyer"("licenseNo");

-- CreateIndex
CREATE UNIQUE INDEX "lawyer_cnic_key" ON "lawyer"("cnic");
