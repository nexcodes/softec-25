...
import { FaShieldAlt, FaUsers, FaLightbulb, FaHandshake, FaGlobe, FaRocket, FaGithub, FaLinkedin } from "react-icons/fa";
...
const teamMembers = [
  ...
  },
  {
    ...
    role: "Backend Developer",
    image: "/Mohid.jpg",
    description: "Full Stack Engineer with a keen interest in Web 3.0 and Blockchain.",
  social: {
    github: "https://github.com/mohidnaeem",
    linkedin: "https://linkedin.com/in/mohidnaeem"
  }
}
];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8">
              Be part of a community-driven effort to reduce crime and build safer neighborhoods.
              Every report helps authorities respond faster and protect more citizens across Pakistan.
            </p>
            
            <Link href="/signup" className="inline-block bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium py-3 px-8 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900">
              Report Crime Now
            </Link>
          </motion.div>
        </div>
