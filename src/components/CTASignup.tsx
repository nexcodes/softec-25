    ...
    <section className="py-20 bg-black overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Join <span className="text-blue-400">10,000+</span> Citizens Making Pakistan Safer
            </h2>
            
            <p className="text-gray-300 text-lg md:text-xl mb-8 max-w-2xl">
              Download our app today and become part of the movement to create safer communities across Pakistan.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mb-10 justify-center lg:justify-start">
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-white text-sm font-medium">Anonymous Reports</p>
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-white text-sm font-medium">Community Support</p>
                  <p className="text-xs text-gray-400">Together We're Stronger</p>
                </div>
              </motion.div>
            </div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <p className="text-gray-400 mb-6">Trusted by communities across Pakistan</p>
